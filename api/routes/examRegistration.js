...
// controllers
const { addExamRegistration, select, updateExamRegistration, deleteExamRegistration, getExamRegistration, getExamResult, downloadCertificate, getOutsideExamCenterByDistrict, getAttendanceSheet, getExamRegistrationList, getOutsideExamAttendanceSheet, getDistrictsExcludingOwn, getRegisteredStudentsList, getConsolidationReport, getExamCentreConsolidation } = require("../controllers/examRegistration");
